...
const Movie = () => {
  ...
  return (
    <section className='movie-body' style={{backgroundImage: setBackgroundImg(movie.poster_path), backgroundRepeat: "no-repeat", backgroundSize: "cover"} }>
        ...
        <div className='grid grid-cols md:grid-cols-2 p-5' style={{position: "relative"}}>
            ...
            <div className='MovieContent'>
                ...
                <div className=''>
                    ...
                    {movie?.genres ? movie?.genres.map(genre => <span className='genre'>{genre.name}</span>) : ""}
                    </div>
                </div>
